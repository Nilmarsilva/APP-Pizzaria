...
- Ação: atualizar perfil/endereço/formas de pagamento.
  - Status: **CRIAR** → endpoints de update de usuário, endereços e métodos de pagamento salvos.
...
- Ação: listar notificações/promos recebidas.
  - Status: **CRIAR** → central de notificações por usuário.
- Ação: marcar como lida/arquivar.
  - Status: **CRIAR** → endpoints de leitura/estado.
